...
Se realizaron diferentes tipos de clasificaciones y análisis de cobertura para cada sector, siendo la clasificación supervisada de máxima verosimilitud la que produjo los datos más concluyentes (Dávalos 2010). Los mapas de cobertura original y de cobertura actual se construyeron con base en la imagen más antigua (1986-1991) y la más reciente (2001). Una vez procesadas las imágenes, se calculó en hectáreas la superficie para cada cobertura, comparándolas con los datos de superficie de manglares obtenidos para cada año. 
