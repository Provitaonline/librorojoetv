...
import { faArrowDown, faArrowLeft, faAngleDoubleDown, faSyncAlt, faCaretRight, faBars, faListUl, faEllipsisH, faTimes } from '@fortawesome/free-solid-svg-icons'
import '@fortawesome/fontawesome-svg-core/styles.css'
config.autoAddCss = false;
library.add(faFacebook, faTwitter, faArrowDown, faArrowLeft, faAngleDoubleDown, faSyncAlt, faCaretRight, faBars, faListUl, faEllipsisH, faTimes)
